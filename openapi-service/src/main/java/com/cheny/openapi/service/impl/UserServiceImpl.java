...
import com.cheny.openapi.common.constant.CommonConstant;
import com.cheny.openapi.common.exception.BusinessException;
import com.cheny.openapi.mapper.UserMapper;
import com.cheny.openapi.model.dto.user.UserQueryRequest;
import com.cheny.openapi.model.enums.UserRoleEnum;
import com.cheny.openapi.model.vo.LoginUserVO;
import com.cheny.openapi.model.vo.UserVO;
import com.cheny.openapi.service.UserService;
import com.cheny.openapi.utils.SqlUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userName, String userPassword, String checkPassword) {
        ...
        synchronized (userName.intern()) {
            ...
            user.setUserAccount(userName+ UUID.randomUUID().toString().substring(0,7));
            user.setUserPassword(encryptPassword);
            String r=RandomUtil.randomNumbers(3);
